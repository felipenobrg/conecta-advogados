    ...
    <AppShell title="Leads Bloqueados" showSidebar={false}>
      <section className="mx-auto w-full max-w-6xl space-y-5 py-6">
        <header className="rounded-3xl border border-[#3d2a5a] bg-[#231540]/90 p-5 shadow-xl backdrop-blur">
          <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#ff4029]">Escassez ativa</p>
          ...
          <p className="mt-2 text-sm text-[#cfc1e4]">
            Escolha um lead bloqueado e libere seu acesso profissional para entrar na fila de oportunidades.
          </p>
          <div className="mt-4 rounded-2xl border border-[#3d2a5a] bg-[#1a0a2e]/80 px-4 py-3 text-sm text-[#ffb29f]">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {leads.map((lead) => (
            <article key={lead.id} className="rounded-2xl border border-[#3d2a5a] bg-[#231540]/85 p-4 shadow-sm backdrop-blur">
